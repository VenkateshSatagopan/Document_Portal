...
FAISS_INDEX_PATH_full = Path("faiss_index/index.faiss")
...
def test_conversational_rag_on_pdf(pdf_path:str, question:str):
    try: 
        ...
        if FAISS_INDEX_PATH.exists() and FAISS_INDEX_PATH_full.exists():
...
if __name__ == "__main__":
    ...
    pdf_path = r"D:\LLMOPS\DOCUMENT_PORTAL\data\single_document_chat\sample.pdf"
